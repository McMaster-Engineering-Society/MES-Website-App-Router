  ...
  return (
    <main className='layout'>
      <section id='info' className='flex flex-col'>
        ...
        >
          <div>
            MES Office Hours are your opportunities to talk one-on-one with the
            MES Executive Team, AVPs, and administrators to get answers to your
            burning questions or voice your concerns. Check below or the
      ...
      <section>
        <PageSection heading='Council Meetings'>
          <div>
            ...
            Representatives, Associate Vice Presidents, and Executives - and non
            -voting appointed officials. General MES Council meetings occur
            periodically throughout the academic year, while the Exec and AVPs
            meet weekly over the summer and during the year. MES Council exists
            to serve students, and our meetings are public for general students
            to attend and provide input from different perspectives.
            <br />
            <br />
            Below, you can check out what the MES Council discusses and debates
            at our council meetings, or use the form to request a discussion
            topic. Any student in the Faculty of Engineering is welcome to join
