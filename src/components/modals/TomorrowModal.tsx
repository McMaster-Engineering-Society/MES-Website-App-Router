        ...
        <div className='flex'>
          ...
          <div className='ml-5'>
            ...
            <p className='text-small mb-1.5'>
              Room <b>H201</b>, <b>4:30 pm (2H), July 31, 2024. </b>
            </p>
            <ButtonLink
              href='/user-dashboard'
