...
const RebookModal: React.FC<RebookModalProps> = ({open, onClose, bookingId}) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <div>
              <b className='text-lg'>Same time<br></br>next week:<br></br></b>
              <i>4:30pm (2H)<br></br></i>
              <i>08/06/24<br></br></i>
            </div>
          </button>
          ...
          >
            <div>
              <b className='text-lg'>Same room, <br></br>time, day:<br></br></b>
              <i>4:30pm (2H)<br></br></i>
              <i>08/06/24<br></br></i>
            </div>
          </button>
        </div>
        <TomorrowModal open={tomorrowOpen} onClose={() => setTomOpen(false)} tomInfo="6531a67db0a3f963db5b4175">
        </TomorrowModal>
      </div>
