...
export const ExternalConferences: ConferencePageSectionType[] = [
  ...
  },
  {
    ...
    dates: 'September 23rd - 25th, 2023',
    delegates: 'VPX and President',
