...
type PolicyProps = PolicyData & {
  updateFields: (fields: Partial<PolicyData>) => void
}

function Policy({ informationSecurityPolicy, studentRightsPolicy, discriminationHarassmentPolicy, sexualViolencePolicy, comments, finalAgreement, updateFields }: PolicyProps) {
  return (
