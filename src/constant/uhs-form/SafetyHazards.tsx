...
import { SafetyHazardsData } from '@/types/uhsForm';
...
function SafetyHazards({
  ...
  return (
    <div className='flex flex-col'>
      <div
        id='text-body'
        className="flex flex-col gap-x-4 gap-y-4 text-[#4b4b4b] text-lg font-medium font-['Inter']"
      >
        ...
        >
          <label className='flex flex-row mt-2 h-fit justify-items-start content-center'>
            <input
              ...
              onChange={(e) =>
                updateFields({ fifthAgreement: e.target.checked })
              }
            />
