...
function Understanding({ firstAgreement, secondAgreement, groupCategory, groupName, updateFields }: UnderstandingProps) {
    ...
    <div className="flex flex-col">
        <div id='text-body' className='flex flex-col gap-x-4 gap-y-4'>
            ...
            <Question title="Which category best describes your group? The MES only provides UHS form submissions for these groups." required={true}>
              <label className="flex flex-row mt-2 h-fit justify-items-start content-center">
                <input required className="mr-2 h-6 w-6 opacity-50 bg-[#ececec] rounded-[10px] border-2 border-black/40" type="radio" name='group' value = "groupMES" checked={groupCategory === "MES Group/Team/Affiliate"} onChange={() => updateFields({ groupCategory: "MES Group/Team/Affiliate"})}/>
                <div className="text-[#4b4b4b] h-fit text-lg font-medium font-['Inter']">MES Group/Team/Affiliate</div>
              </label>
              <label className="flex flex-row mt-2 h-fit justify-items-start content-center">
                <input className="mr-2 h-6 w-6 opacity-50 bg-[#ececec] rounded-[10px] border-2 border-black/40" type="radio" name='group' value = "groupDepartment" checked={groupCategory === "Department Program/Club"} onChange={() => updateFields({ groupCategory: "Department Program/Club"})} />
                <div className="text-[#4b4b4b] h-fit text-lg font-medium font-['Inter']">Department Program/Club</div>
              </label>
              <label className="flex flex-row mt-2 h-fit justify-items-start content-center">
                <input className="mr-2 h-6 w-6 opacity-50 bg-[#ececec] rounded-[10px] border-2 border-black/40" type="radio" name='group' value = "groupCommittee" checked={groupCategory === "MES Committee and/or MES Council"} onChange={() => updateFields({ groupCategory: "MES Committee and/or MES Council"})} />
